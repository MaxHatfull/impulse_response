class Level
  class Terminal
    def self.create(parent:, x:, z:, options: [], welcome_clip: nil, powered: true)
      ambient_source = Level::SoundSource.create(parent: parent, x: x, z: z, clip: Sounds.terminal, volume: 0.2, play_on_start: powered)
